...
/**
 * Plugin Name: Triard 3D Product customization & AR
 * Plugin URI: https://triard.io/
...
function db_3d_viewer_admin_page()
{
    ...
    echo '<div class="wrap">';
    echo '<h1>Triard 3D Product customization & AR - Upload GLB File</h1>';

    // Display the file upload form.
    echo '<form method="post" class="upload-form" action="">';
    ...
    wp_enqueue_style('db-3d-viewer-admin-page-style', plugin_dir_url(__FILE__) . 'db-3d-product-viewer.css');
...
function add_plugin_action_links($links) {
    $mylinks = array(
        '<a href="' . admin_url('options-general.php?page=my-plugin-settings') . '">View Details</a>'
    );
